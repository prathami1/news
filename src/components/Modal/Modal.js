    ...
    body = (
      <div className={classes.paper}>
        ...
        <div className={classes.infoContainer}>
          <Typography variant="h5">Search News by Categories</Typography>
        ...
        <Divider />
        <div className={classes.infoContainer}>
          <Typography variant="h5">Search News by Terms</Typography>
        ...
        <Divider />
        <div className={classes.infoContainer}>
          <Typography variant="h5">Search News by Sources</Typography>
